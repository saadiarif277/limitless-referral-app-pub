...
const AppFormBuilder = defineAsyncComponent(() => import("./components/application/app-form-builder.vue"));
const AppFormFieldBuilder = defineAsyncComponent(() => import("./components/application/app-form-fields-builder.vue"));
const AppFormField = defineAsyncComponent(() => import("./components/application/app-form-field.vue"));
...
const FormRadioCard = defineAsyncComponent(() => import("./components/form/form-radio-card.vue"));
...
const FormToggle = defineAsyncComponent(() => import("./components/form/form-toggle.vue"));
...
const SectionDivider = defineAsyncComponent(() => import("./components/section-divider.vue"));
...
const components = {
    ...
    "v-app-form-builder": AppFormBuilder,
    "v-app-form-fields-builder": AppFormFieldBuilder,
    "v-app-form-field": AppFormField,
    "v-app-logo": AppLogo,
    ...
    "v-form-radio-card": FormRadioCard,
    "v-form-select": FormSelect,
    "v-form-textarea": FormTextarea,
    "v-form-toggle": FormToggle,
    "v-form": Form,
    "v-heading": Heading,
    ...
    "v-section-divider": SectionDivider,
