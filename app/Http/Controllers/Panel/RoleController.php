...
class RoleController extends Controller
{
    ...
    {
        return Inertia::render('panel/roles/roles-list', [
    ...
    {
        return Inertia::render('panel/roles/roles-create-edit', [
            'documentCategories' => DocumentCategoryResource::collection(DocumentCategory::with('documentTypes')->get()),
    ...
    public function store(StoreRoleRequest $request)
    {
        ...
        return to_route('panel.roles.show', [
            'role' => $role->getKey(),
        ]);
    }
    ...
    {
        $role->delete();
        return to_route('panel.roles.index');
    }
}
