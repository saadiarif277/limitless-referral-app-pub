...
class DocumentTypeController extends Controller
{
    ...
    {
        return Inertia::render('panel/document-types/document-types-list', [
    ...
    {
        return Inertia::render('panel/document-types/document-types-create-edit', [
            'documentCategories' => DocumentCategoryResource::collection(DocumentCategory::all()),
    ...
    public function store(StoreDocumentTypeRequest $request)
    {
        ...
        return to_route('panel.document-types.show', [
    ...
    {
        $documentType->delete();
        return to_route('panel.document-types.index');
    }
}
