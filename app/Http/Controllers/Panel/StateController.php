...
class StateController extends Controller
{
    ...
    {
        return Inertia::render('panel/states/states-list', [
    ...
    {
        return Inertia::render('panel/states/states-create-edit', [
            'documentTypes' => DocumentTypeResource::collection(DocumentType::all()),
        ]);
    }
    ...
    public function store(StoreStateRequest $request)
    {
        ...
        return to_route('panel.states.show', [
            'state' => $state->getKey(),
        ]);
    }
    ...
    {
        $state->delete();
        return to_route('panel.states.index');
    }
}
